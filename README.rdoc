...
== Set Up
 ...
 $ cp config/medvane.yml.sample config/medvane.yml
 $ rake mdvn:setup
...
Medvane Solo is released under MIT license (see included MIT-LICENSE or http://creativecommons.org/licenses/MIT/).