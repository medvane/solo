class Author < ActiveRecord::Base
  ...
  has_many :author_coauthors, :class_name => "Coauthorship", :include => :coauthor, :order => "coauthorships.all_total desc, coauthorships.all_first desc, coauthorships.all_last desc, coauthorships.all_middle desc, authors.last_name"
